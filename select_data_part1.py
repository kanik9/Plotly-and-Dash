...
#Creating dataset :
np.random.seed(10)
x_value_left = np.linspace(0.1,5,50)
x_value_right = np.linspace(5.1,10,50)

y = np.random.randint(0,50,50)

# importing the dataset
df1 =pd.DataFrame({'x':x_value_left,'y':y})
df2 =pd.DataFrame({'x':x_value_left,'y':y})
df3 =pd.DataFrame({'x':x_value_right,'y':y})
